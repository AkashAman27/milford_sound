-- SEO Fields Migration
-- This migration adds comprehensive SEO fields to experiences and blog_posts tables
...
-- Update updated_at trigger for experiences
...
-- Optional: Update existing records with default SEO values
