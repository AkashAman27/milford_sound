-- SQL script to add missing columns to FAQs table
-- Run this in your Supabase SQL editor

-- Add experience_id column if it doesn't exist
ALTER TABLE faqs ADD COLUMN IF NOT EXISTS experience_id UUID REFERENCES experiences(id) ON DELETE CASCADE;

-- Add show_on_tour_page column if it doesn't exist
ALTER TABLE faqs ADD COLUMN IF NOT EXISTS show_on_tour_page BOOLEAN DEFAULT false;
